...
import (
	...
	"github.com/shittu24/rms/database"
	helper "github.com/shittu24/rms/helpers"
	"github.com/shittu24/rms/models"
...
func SignUp() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		//if all ok, then you insert new user into the user collection
